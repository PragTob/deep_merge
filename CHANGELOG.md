...
### Bugfixes
* There was a bug where running with test coverage changed the fallback merge behavior for structs locally. The detection mechanism has been changed and the tests for those circumstances fixed.
